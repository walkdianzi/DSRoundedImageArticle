...
@interface RoundFiveDemoViewController()
...
- (void)viewDidLoad{
    ...
    contentScrollView.contentSize = CGSizeMake(self.view.frame.size.width, 3500);
    ...
    for(int i = 0; i < 400; i++){
        ...
        [avatarImageViewUrl sd_setImageWithURL:[NSURL URLWithString:[self urlStr:i]]];
