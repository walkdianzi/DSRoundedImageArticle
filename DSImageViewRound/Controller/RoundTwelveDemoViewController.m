//
//  RoundTwelveDemoViewController.m
//  DSImageViewRound
//
//  Created by dasheng on 16/5/18.
//  Copyright © 2016年 dasheng. All rights reserved.
//

#import "RoundTwelveDemoViewController.h"
...
@interface RoundTwelveDemoViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation RoundTwelveDemoViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    for (int i=1; i<=total; i++) {
        ...
        imageView.aliCornerRadius = kHeight/2;
